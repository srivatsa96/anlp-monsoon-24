...
class Config:
    def __init__(self,tokeniser):
        ...
        self.pe_mode = 'learnable'  # Positional encoding method
        self.share_embedding = False  # Whether to share embeddings
        self.n_layer = 6  # Number of transformer layers
        self.enc_block_size = 100  # Encoder block size
        self.dec_block_size = 100  # Decoder block size
        self.head_size = self.n_embed // self.num_heads # Dimension of each head

class TrainConfig:
    def __init__(self, accelerator):
        self.batch_size = 32
        self.epochs = 50  # No of Pass over train data
